...
# Първоначално прочитаме от конзолата на отделни редове
# размерите му – дължина, широчина и височина в сантиметри.
...
width = int(input())
height = int(input())
taken_space_percent = int(input())

volume = length * width * height
volume_in_litres = volume / 1000
water_for_fill = volume_in_litres * (1 - (taken_space_percent / 100))

print(water_for_fill)